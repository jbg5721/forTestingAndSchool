...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
    ...
    <xsl:template match="xml" mode="toc">
        <li><a href="#{descendant::title/@xml:id}"><xsl:apply-templates select="descendant::title" /></a></li>
    ...
    <xsl:template match="xml">
        <a href="#{descendant::h1}"><h2 id="{descendant::title/@xml:id}"><xsl:apply-templates select="descendant::title" /></h2></a><div class="img"><img src="images/1929-12-17_ParentsLetterFront.JPG" alt="image from my archive"/></div>
        <br/>
